...
func startV2RayPlugin(remoteAddr string, remotePort int, host string, path string, tls bool, mode string, mux int) (bool) {
	...
	*remotePort = remotePort
	...
	if err != nil {
		fmt.Println("failed to create v2ray instance")
		return false
	}

	if err := instance.Start(); err != nil {
		fmt.Println("failed to start v2ray plugin")
		return false
	}
